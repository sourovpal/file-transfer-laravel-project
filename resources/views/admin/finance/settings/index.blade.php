				...
				<div class="card border-0">
					...
					<div class="card-body pb-6">
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								<h6 class="fs-12 font-weight-bold mb-4"><i class="fa-brands fa-cc-paypal fs-16 mr-2"></i>PayPal Payment Gateway <span class="text-primary">({{ __('Monthly/Yearly/Lifetime Plans') }})</span></h6>
									...
									<div class="col-md-6 col-sm-12 mb-2">
										<div class="form-group">
											<label class="custom-switch">
												...
												<span class="custom-switch-description">Enable PayPal</span>
											</label>
										</div>
									</div>
								</div>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><i class="fa-brands fa-cc-stripe fs-16 mr-2"></i>Stripe Payment Gateway <span class="text-primary">({{ __('Monthly/Yearly/Lifetime Plans') }})</span></h6>
									...
									<div class="col-md-6 col-sm-12 mb-2">
										<div class="form-group">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">Enable Stripe</span>
											</label>
										</div>
									</div>
								</div>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ URL::asset('/img/payments/paystack.svg') }}" alt="Paystack" class="gateway-logo">Paystack Payment Gateway <span class="text-primary">({{ __('Monthly/Yearly/Lifetime Plans') }})</span></h6>
									...
									<div class="col-md-6 col-sm-12 mb-2">
										<div class="form-group">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">Enable Paystack</span>
											</label>
										</div>
									</div>
								</div>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ URL::asset('/img/payments/razorpay.svg') }}" alt="Razorpay" class="gateway-logo">Razorpay Payment Gateway <span class="text-primary">({{ __('Monthly/Yearly/Lifetime Plans') }})</span></h6>
									...
									<div class="col-md-6 col-sm-12 mb-2">
										<div class="form-group">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">Enable Razorpay</span>
											</label>
										</div>
									</div>
								</div>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ URL::asset('/img/payments/mollie.svg') }}" alt="Mollie" class="gateway-logo gateway-small-logo">Mollie Payment Gateway <span class="text-primary">({{ __('Monthly/Yearly/Lifetime Plans') }})</span></h6>
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">Use Mollie</span>
											</label>
										</div>
									</div>
								</div>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ URL::asset('/img/payments/braintree.svg') }}" alt="Braintree" class="gateway-logo">Braintree Payment Gateway <span class="text-primary">({{ __('Lifetime Plans') }})</span></h6>
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">Use Braintree</span>
											</label>
										</div>
									</div>
								</div>
					...
					<div class="card-body pb-6">
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ URL::asset('/img/payments/coinbase.svg') }}" alt="Coinbase" class="gateway-logo">{{ __('Coinbase Commerce Payment Gateway') }} <span class="text-primary">({{ __('Lifetime Plans') }})</span></h6>
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">Enable Coinbase</span>
											</label>
										</div>
									</div>
								</div>
					...
					<div class="card-body">
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><i class="fa-solid fa-money-check-dollar-pen fs-16 mr-2"></i>{{ __('Bank Transfer Payment') }} <span class="text-primary">({{ __('Monthly/Yearly/Lifetime Plans') }})</span></h6>
