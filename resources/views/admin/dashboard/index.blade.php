		...
		<div class="col-lg-4 col-md-6 col-sm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-700">{{ __('Total File Transfers') }} <span class="text-muted">({{ __('Current Month') }})</span></p>
							<h2 class="mb-0"><span class="number-font fs-20">{{ number_format($total_data_monthly['file_uploads_current_month']) }}</span><span class="ml-2 text-muted fs-11 data-percentage-change"><span id="transfers_change"></span> {{ __('this month') }}</span></h2>
					...
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-11 mr-1">{{ __('Last Month') }}</span>
							<span class="number-font fs-11"><i class="fa fa-chain mr-1 text-success"></i>{{ number_format($total_data_monthly['file_uploads_past_month']) }}</span>
						</div>
						<div class="ml-auto">
							<span class="text-muted fs-11 mr-1">{{ __('Total') }} ({{ __('Current Year') }})</span>
							<span class="number-font fs-11"><i class="fa fa-bookmark mr-1 text-success"></i>{{ number_format($total_data_yearly['total_file_uploads']) }}</span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-lg-4 col-md-6 col-sm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-700">{{ __('Total Shared via Link') }} <span class="text-muted">({{ __('Current Month') }})</span></p>
							<h2 class="mb-0"><span class="number-font fs-20">{{ number_format($total_data_monthly['links_current_month']) }}</span><span class="ml-2 text-muted fs-11 data-percentage-change"><span id="links_change"></span> {{ __('this month') }}</span></h2>
					...
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-11 mr-1">{{ __('Last Month') }}</span>
							<span class="number-font fs-11"><i class="fa fa-chain mr-1 text-success"></i>{{ number_format($total_data_monthly['links_past_month']) }}</span>
						</div>
						<div class="ml-auto">
							<span class="text-muted fs-11 mr-1">{{ __('Total') }} ({{ __('Current Year') }})</span>
							<span class="number-font fs-11"><i class="fa fa-bookmark mr-1 text-success"></i>{{ number_format($total_data_yearly['total_links']) }}</span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-lg-4 col-md-6 col-sm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-700">{{ __('Total Shared via Email') }} <span class="text-muted">({{ __('Current Month') }})</span></p>
							<h2 class="mb-0"><span class="number-font fs-20">{{ number_format($total_data_monthly['emails_current_month']) }}</span><span class="ml-2 text-muted fs-11 data-percentage-change"><span id="emails_change"></span> {{ __('this month') }}</span></h2>
					...
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-11 mr-1">{{ __('Last Month') }}</span>
							<span class="number-font fs-11"><i class="fa fa-chain mr-1 text-success"></i>{{ number_format($total_data_monthly['emails_past_month']) }}</span>
						</div>
						<div class="ml-auto">
							<span class="text-muted fs-11 mr-1">{{ __('Total') }} ({{ __('Current Year') }})</span>
							<span class="number-font fs-11"><i class="fa fa-bookmark mr-1 text-success"></i>{{ number_format($total_data_yearly['total_emails']) }}</span>
						</div>
					</div>
				</div>
			</div>
