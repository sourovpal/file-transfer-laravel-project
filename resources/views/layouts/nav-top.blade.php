            ...
            <div class="d-flex order-lg-2 ml-auto"> 
                ...
                <div class="dropdown profile-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                        ...
                        <a class="dropdown-item d-flex" href="{{ route('user.transfer.upload') }}">
                            <span class="profile-icon fa-solid fa-shuffle"></span>
                            <div class="fs-12">{{ __('Transfer File') }}</div>
                        </a>
                        <a class="dropdown-item d-flex" href="{{ route('user.transfer.list') }}">
                            <span class="profile-icon fa-solid fa-box-circle-check"></span>
                            <div class="fs-12">{{ __('My Transfer List') }}</div>
                        </a>
