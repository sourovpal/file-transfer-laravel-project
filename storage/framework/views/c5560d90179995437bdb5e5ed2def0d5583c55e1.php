...
<?php $__env->startSection('page-header'); ?>
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0"><?php echo e(__('Frontend Transfer Files')); ?></h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#"> <?php echo e(__('Frontend Transfer Files')); ?></a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
			...
			<div class="card border-0">
				<div class="card-body pt-2">
					...
					<div class="d-inline border-0">						
						<div>
							<h3 class="card-title fs-16 mt-3 mb-4"><i class="fa-solid fa-shuffle mr-4 text-info"></i><?php echo e(__('All Guest Transfered Files')); ?></h3>
						</div>
					</div>
					<!-- BOX CONTENT -->
	...
	<script type="text/javascript">
		$(function () {
			...
			let table = $('#allResultsTable').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: "<?php echo e(route('admin.transfer.list.guest')); ?>",
				columns: [
					{
						data: 'custom-name',
						name: 'custom-name',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hgdtksec/activec8fbc3cde6ecab5955cdad00.com/resources/views/admin/transfers/results/guests/index.blade.php ENDPATH**/ ?>