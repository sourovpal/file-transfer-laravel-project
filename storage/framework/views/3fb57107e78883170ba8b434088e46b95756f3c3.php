			...
			<?php if($monthly || $yearly || $lifetime): ?>
				...
				<div class="tab-menu-heading text-center">
					<div class="tabs-menu">								
						<ul class="nav">							
							<?php if($monthly): ?>
								<li><a href="#monthly_plans" class="<?php if(($monthly && $lifetime && $yearly) || ($monthly && !$lifetime && !$yearly) || ($monthly && $lifetime && !$yearly) || ($monthly && !$lifetime && $yearly)): ?> active <?php else: ?> '' <?php endif; ?>" data-bs-toggle="tab"> <?php echo e(__('Monthly Plans')); ?></a></li>
							<?php endif; ?>	
							<?php if($yearly): ?>
								<li><a href="#yearly_plans" class="<?php if(!$monthly && !$lifetime && $yearly): ?> active <?php else: ?> '' <?php endif; ?>" data-bs-toggle="tab"> <?php echo e(__('Yearly Plans')); ?></a></li>
							<?php endif; ?>	
							<?php if($lifetime): ?>
				...
				<div class="tabs-menu-body">
					<div class="tab-content">
														...
														<div class="card border-0 p-4 pl-5 pr-5 pt-7 price-card <?php if($subscription->featured): ?> price-card-border <?php endif; ?>">
															...
															<div class="plan">			
																...
																<div class="text-center action-button mt-2 mb-4">
																	...
																	<?php else: ?>
																		<a href="<?php echo e(route('user.prepaid.checkout', $subscription->id)); ?>" class="btn btn-primary"><?php echo e(__('Subscribe Now')); ?></a>
																	<?php endif; ?>															
																</div>
						...
						<?php if($monthly): ?>	
							<div class="tab-pane <?php if(($monthly && $lifetime) || ($monthly && !$lifetime) || ($monthly && !$yearly)): ?> active <?php else: ?> '' <?php endif; ?>" id="monthly_plans">
						...
						<?php if($yearly): ?>	
							<div class="tab-pane <?php if(($yearly && $lifetime) && ($yearly && !$lifetime) && ($yearly && !$monthly)): ?> active <?php else: ?> '' <?php endif; ?>" id="yearly_plans">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hgdtksec/activec8fbc3cde6ecab5955cdad00.com/resources/views/user/plans/index.blade.php ENDPATH**/ ?>