		...
		<div class="col-lg-4 col-md-6 col-sm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-700"><?php echo e(__('Total File Transfers')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-0"><span class="number-font fs-20"><?php echo e(number_format($total_data_monthly['file_uploads_current_month'])); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"><span id="transfers_change"></span> <?php echo e(__('this month')); ?></span></h2>

						</div>
						<span class="fs-40 text-primary mt-m1"><i class="fa-solid fa-cloud-arrow-up"></i></span>
					</div>
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-11 mr-1"><?php echo e(__('Last Month')); ?></span>
							<span class="number-font fs-11"><i class="fa fa-chain mr-1 text-success"></i><?php echo e(number_format($total_data_monthly['file_uploads_past_month'])); ?></span>
						</div>
						<div class="ml-auto">
							<span class="text-muted fs-11 mr-1"><?php echo e(__('Total')); ?> (<?php echo e(__('Current Year')); ?>)</span>
							<span class="number-font fs-11"><i class="fa fa-bookmark mr-1 text-success"></i><?php echo e(number_format($total_data_yearly['total_file_uploads'])); ?></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-lg-4 col-md-6 col-sm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-700"><?php echo e(__('Total Shared via Link')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-0"><span class="number-font fs-20"><?php echo e(number_format($total_data_monthly['links_current_month'])); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"><span id="links_change"></span> <?php echo e(__('this month')); ?></span></h2>

						</div>
						<span class="fs-40 mt-m1"><i class="fa-solid fa-link"></i></span>
					</div>
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-11 mr-1"><?php echo e(__('Last Month')); ?></span>
							<span class="number-font fs-11"><i class="fa fa-chain mr-1 text-success"></i><?php echo e(number_format($total_data_monthly['links_past_month'])); ?></span>
						</div>
						<div class="ml-auto">
							<span class="text-muted fs-11 mr-1"><?php echo e(__('Total')); ?> (<?php echo e(__('Current Year')); ?>)</span>
							<span class="number-font fs-11"><i class="fa fa-bookmark mr-1 text-success"></i><?php echo e(number_format($total_data_yearly['total_links'])); ?></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-lg-4 col-md-6 col-sm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-700"><?php echo e(__('Total Shared via Email')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-0"><span class="number-font fs-20"><?php echo e(number_format($total_data_monthly['emails_current_month'])); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"><span id="emails_change"></span> <?php echo e(__('this month')); ?></span></h2>

						</div>
						<span class="fs-40 text-yellow mt-m1"><i class="fa-solid fa-envelope-circle-check"></i></span>
					</div>
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-11 mr-1"><?php echo e(__('Last Month')); ?></span>
							<span class="number-font fs-11"><i class="fa fa-chain mr-1 text-success"></i><?php echo e(number_format($total_data_monthly['emails_past_month'])); ?></span>
						</div>
						<div class="ml-auto">
							<span class="text-muted fs-11 mr-1"><?php echo e(__('Total')); ?> (<?php echo e(__('Current Year')); ?>)</span>
							<span class="number-font fs-11"><i class="fa fa-bookmark mr-1 text-success"></i><?php echo e(number_format($total_data_yearly['total_emails'])); ?></span>
						</div>
					</div>
				</div>
			</div>
...
<?php $__env->startSection('js'); ?>
	...
	<script type="text/javascript">
		$(function() {
			...
			var transfers_current_month = JSON.parse(`<?php echo $percentage['transfers_current']; ?>`);
			var transfers_past_month = JSON.parse(`<?php echo $percentage['transfers_past']; ?>`);
			var links_current_month = JSON.parse(`<?php echo $percentage['links_current']; ?>`);
			var links_past_month = JSON.parse(`<?php echo $percentage['links_past']; ?>`);
			var emails_current_month = JSON.parse(`<?php echo $percentage['emails_current']; ?>`);
			var emails_past_month = JSON.parse(`<?php echo $percentage['emails_past']; ?>`);
			...
			var transfers_current_total = parseInt(transfers_current_month);
			var transfers_past_total = parseInt(transfers_past_month);
			var links_current_total = parseInt(links_current_month);
			var links_past_total = parseInt(links_past_month);
			var emails_current_total = parseInt(emails_current_month);
			var emails_past_total = parseInt(emails_past_month);
			...
			var transfers_change = mainPercentageDifference(transfers_past_month, transfers_current_month);
			var links_change = mainPercentageDifference(links_past_month, links_current_month);
			var emails_change = mainPercentageDifference(emails_past_month, emails_current_month);
			...
			document.getElementById('transfers_change').innerHTML = transfers_change;
			document.getElementById('links_change').innerHTML = links_change;
			document.getElementById('emails_change').innerHTML = emails_change;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hgdtksec/activec8fbc3cde6ecab5955cdad00.com/resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>