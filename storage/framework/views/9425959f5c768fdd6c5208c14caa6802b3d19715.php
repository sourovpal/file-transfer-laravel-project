<?php $__env->startSection('css'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('css/tagsinput.css')); ?>">
                                ...
                                <div class="col-lg-5 col-md-6 col-sm-12 ml-8 upload-responsive" data-aos="fade-right" data-aos-delay="300" data-aos-once="true" data-aos-duration="700">                             
                                    ...
                                    <div class="card border-0 special-card">
                                        <div class="card-body">			
                                            ...
                                            <?php if((config('settings.password_protection_feature_frontend') == 'enable') || (config('settings.link_expiration_feature_frontend') == 'enable')): ?>
...
unset($__errorArgs, $__bag); ?>" id="email-to" name="email_to" autocomplete="off">
                                                            ...
                                                            <input style="display:none;" type="file" accept=".csv, .txt" class="form-control <?php $__errorArgs = ['email-to-csv'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="email-to-csv" name="email_to_csv" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="card-footer border-0 text-center p-0">
                                                <div class="w-100">
                                                    <div class="text-center">
                                                        ...
                                                        <button type="submit" name="submit" class="btn btn-primary pl-6 pr-6 frontend-button" id="transfer"><?php echo e(__('Transfer')); ?></button>
                                                    </div>
                                                </div>							
                                            </div>							
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 pt-7 pl-8 upload-responsive">
                                    <div class="text-container text-center">
                                        <h1 class="mb-4 text-white" data-aos="fade-left" data-aos-delay="400" data-aos-once="true" data-aos-duration="700"><?php echo e(__('Cloud File Transfer')); ?></span></h1>
                                        <h1 class="mb-4 text-yellow" data-aos="fade-left" data-aos-delay="500" data-aos-once="true" data-aos-duration="900"><?php echo e(__('Transfer big files around the world')); ?></h1>
                                        <p class="fs-20 text-white" data-aos="fade-left" data-aos-delay="600" data-aos-once="true" data-aos-duration="1100"><?php echo e(__('Secure, durable cloud solution for file transfering')); ?> <br> <?php echo e(__('Unmatched durability and scalability')); ?></p>

                                        <a href="<?php echo e(route('register')); ?>" class="btn btn-primary special-action-button frontend-button" data-aos="fade-left" data-aos-delay="800" data-aos-once="true" data-aos-duration="1100"><?php echo e(__('Try Now')); ?></a>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                    <div class="modal-content special-card">
                                        <div class="modal-header mb-1">
                                            <h4 class="modal-title" id="myModalLabel"><i class="fas fa-sliders-h text-primary"></i> <?php echo e(__('Additional Transfer Settings')); ?></h4>
                                        ...
                                        <div class="modal-body pb-0 pl-6 pr-6">        
                                            <div class="input-box no-gutters">	
                                                ...
                                                <?php if(config('settings.link_expiration_feature_frontend') == 'enable'): ?>
                                                    <div class="col-sm-12">
                                                        <div id="form-group">
                                                ...
                                                <?php if(config('settings.password_protection_feature_frontend') == 'enable'): ?>
                                                    <div class="col-sm-12">
                                                        <div id="form-group">
                                                    ...
                                                    <div class="col-sm-12">								
                                                        <div class="input-box password-box">								
                                                            <h6 class="fs-11 mb-2 font-weight-bold"><?php echo e(__('Password')); ?> </h6>
                                                            <div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="modal-footer pr-6 pb-3 modal-footer-awselect">
                                            <button type="button" class="btn btn-cancel mb-4" data-bs-dismiss="modal"><?php echo e(__('Return')); ?></button>
                                        </div>                                                    
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row d-flex" id="solutions-list">
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1000" data-aos-once="true" data-aos-duration="1000">                                                                          
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <h5><?php echo e(__('Glacier & Deep Archive Tiers')); ?></h5>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1500" data-aos-once="true" data-aos-duration="1500">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <h5><?php echo e(__('Lowest Cost for Storage')); ?></h5>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="2000" data-aos-once="true" data-aos-duration="2000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <h5><?php echo e(__('Most Comprehensive Security')); ?></h5>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1000" data-aos-once="true" data-aos-duration="1000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <h5><?php echo e(__('Instant Retrieval with Glacier Tier')); ?></h5>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1500" data-aos-once="true" data-aos-duration="1500">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <h5><?php echo e(__('Long-term Backup Retention')); ?></h5>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="2000" data-aos-once="true" data-aos-duration="2000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <h5><?php echo e(__('High Availability with Data Replication')); ?></h5>
                        ...
                        <div class="col-md-4 col-sm-12 d-flex">
                            ...
                            <div class="feature-text">
                                <div>
                                    <h4><span class="text-primary"><?php echo e(config('app.name')); ?></span> <?php echo e(__('Provides the most durable solution in the world')); ?></h4>
                                </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(URL::asset('js/tagsinput.js')); ?>"></script>
    ...
    <script type="text/javascript">
		...
		$.ajax({
			...
			FilePond.setOptions({
				...
				labelIdle: "<?php echo e(__('Drag & Drop files to transfer ')); ?> <span class=\"filepond--label-action\"><?php echo e(__('Files')); ?> / </span><span class='filepond--label-action' onclick='addAttributeInput()'>Folder</span><br><span class='restrictions'><span class='restrictions-highlight'><?php echo e(__('Max Size')); ?>: " + data['max_file_size'] + "MB, <?php echo e(__('Max Files')); ?>: " + data['max_file_quantity'] + "</span></span>",
				required: true,
				server: {
					process: "tmp-upload",
					revert: "tmp-delete",
			...
			$.ajax({
				...
				success: function (data) {
					...
					if (data['status'] == 'success') {
						...
						Swal.fire('<?php echo e(__('File Transfer Error')); ?>', data['message'], 'error');
					}
				},
				error: function(data) {
					$('#transfer').prop('disabled', false);
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\file-transfer-laravel-project\resources\views/home.blade.php ENDPATH**/ ?>